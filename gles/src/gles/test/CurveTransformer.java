...
public class CurveTransformer {
    ...
    private static final String overlayShader =
    ...
    private static final String multiplyShader =
	"precision mediump float;" +
	"varying highp vec2 textureCoordinate1;" +
	"uniform sampler2D inputImageTexture1;" +
    ...
    private static final String screenShader =
	"precision mediump float;" +
	"varying highp vec2 textureCoordinate1;" +
	"uniform sampler2D inputImageTexture1;" +
    ...
    private static final String hardlightShader =
	"precision mediump float;" +
	"varying highp vec2 textureCoordinate1;" +
	"uniform sampler2D inputImageTexture1;" +
    ...
    private static final String softlightShader =
	"precision mediump float;" +
	"varying highp vec2 textureCoordinate1;" +
	"uniform sampler2D inputImageTexture1;" +
    ...
    private static final String dodgeShader =
	"precision mediump float;" +
	"varying highp vec2 textureCoordinate1;" +
	"uniform sampler2D inputImageTexture1;" +
    ...
    private static final String normalShader =
	"precision mediump float;" +
	"varying highp vec2 textureCoordinate1;" +
	"uniform sampler2D inputImageTexture1;" +
    ...
    private static final String colorShader =
	"precision mediump float;" +
	"varying highp vec2 textureCoordinate1;" +
	"uniform sampler2D inputImageTexture1;" +
    ...
    private static final String saturationShader =
	"precision mediump float;" +
	"varying highp vec2 textureCoordinate1;" +
	"uniform sampler2D inputImageTexture1;" +
    ...
    private static final String hueShader =
	"precision mediump float;" +
	"varying highp vec2 textureCoordinate1;" +
	"uniform sampler2D inputImageTexture1;" +
    ...
    private static final String lightenShader =
	"precision mediump float;" +
	"varying highp vec2 textureCoordinate1;" +
	"uniform sampler2D inputImageTexture1;" +
